...
bool Animations::WishVelDemonstration(sf::RenderTarget& window)
{
    ...
    if (font.loadFromFile("fonts/Dosis-Regular.ttf"))
    {
        if (mode == MODE_POINTS)
        {
            ...
            DrawUtil::DrawPoint(window, DrawUtil::center, sf::Color::White, 20.0 * bounce);
            ...
            DrawUtil::DrawRect(window, (screenDimensions.x / 2) - 155, 0, sf::Vector2f(310, 110), sf::Color(255, 255, 255, 255 * tolerance));
            DrawUtil::DrawTextSF(window, (screenDimensions.x / 2) - 155 + 20, 20, font, text, fontSize, textColor);
        }
        ...
        else if (mode == MODE_VIEWANGLES)
        {
            ...
            DrawUtil::DrawRect(window, (screenDimensions.x / 2) - 320, 0, sf::Vector2f(640, 100), sf::Color(255, 255, 255, 255 * tolerance));
            DrawUtil::DrawTextSF(window, (screenDimensions.x / 2) - 320 + 20, 20, font, text, fontSize, textColor);
            ...
            DrawUtil::DrawRect(window, xOffset + ptYaw[0], yOffset + ptYaw[1], sf::Vector2f(450, 170), sf::Color(255, 255, 255, 255 * tolerance));
        ...
        else
        {
            ...
            else
            {
                ...
                if (mode == MODE_WISHVEL_EYEANGLES)
                {
                    ManuallyUpdateStuff();
                    ...
                    // Draw the top rect
                    DrawUtil::DrawRect(window, 0, 0, sf::Vector2f(620, 380), sf::Color(255, 255, 255, 255 * tolerance));
                    DrawUtil::DrawTextSF(window, 20, 20, font, text, fontSize, textColor);
